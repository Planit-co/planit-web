  ...
  return (
    <div className="signup-container flex items-center justify-center md:gap-5 lg:gap-24 ">
      ...
      <div className="form-container flex flex-col w-full sm:w-3/5 md:w-1/3 justify-center">
        ...
        <p className="text-sm font-medium mb-10 text-center">
        ...
        <form className="signup-form xl:px-3 xl:py-4 text-sm xl:text-base">
          ...
          <div className="mb-2">
            ...
            <div className="relative">
              ...
              />
              <div
                className={`absolute right-5 top-1/2 bottom-1/2 -translate-y-1/2 border w-5 border-[#9CA3AF] bg-[#9CA3AF] rotate-150 ${showPassword ? "hidden" : "block"}`}
              ></div>
            </div>
          </div>
